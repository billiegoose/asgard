...
\begin{tabular}{llrrr}
\hline
Program & Machine & \begin{tabular}{@{}c@{}}Memory Usage\\(Words)\end{tabular}
& \begin{tabular}{@{}c@{}}Instructions\\Executed\end{tabular}
& \begin{tabular}{@{}c@{}}Execution Time\\(Seconds)\end{tabular}\\
\hline
sine & RED2 & 322 & 3,226 & 0.33\\
sine & WINTER & 24,708 & 9,234 & 1.10\\
game & RED2 & 1,952 & 1,227,197 & 100.0\\
game & WINTER & 18,816 & 6,697 & 0.8\\
\hline
\end{tabular}
\caption[Comparison of RED2 and WINTER]{Benchmark comparison of RED2 with WINTER, an implementation of the
...
\begin{tabular}{lrrr}
\hline
Task & \begin{tabular}{@{}c@{}}Memory Usage\\(Words)\end{tabular}
& \begin{tabular}{@{}c@{}}Instructions\\Executed\end{tabular}
& \begin{tabular}{@{}c@{}}Execution Time\\(Seconds)\end{tabular}\\
\hline
build tree & 2,670 & 40,120 & 2.63\\
evaluate tree & 1,176 & 93,796 & 5.60\\
total cost & 3,846 & 133,916 & 8.23\\
\hline
\end{tabular}
\caption[Sharing analysis]{Experimental evidence suggesting that RED2 performed poorly on the
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{assets/chapter5/figure-5-1.png}
\caption[Incremental memory management]{All of RED2's built-in primitive operations assist in memory
management. In this example an arithmetic primitive discards graph nodes which
are no longer accessible by adjusting the \(fsp\). The pictures show the tip of
the result graph just before and just after the addition primitive is fired.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{assets/chapter5/figure-5-2.png}
\caption[Discarding subgraphs]{The IF primitive demonstrates why subgraphs must be promptly
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{assets/chapter5/figure-5-3.png}
\caption[Implementing sharing, Part 1]{Forward execution of a VAR instruction that is not the head of a
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{assets/chapter5/figure-5-4.png}
\caption[Implementing Sharing: Part 2]{Execution of a JOIN instruction. If the destination of the JOIN is an
EP and the reduced argument is an atomic value, the atomic value overwrites the
closure pointed to by the EP. In this way, the reduced argument is shared
...
\[
\lambda x.(e x)\longrightarrow e
\]
if \(x\) does not occur as a free variable in \(e\). An \(\eta\)-redex can arise
...
\[
\lambda x.(((\lambda y.\lambda z.z)\ x)\ x)
\]
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{assets/chapter5/figure-5-5.png}
\caption[Contraction of an \(\eta\)-redex]{Contraction of an \(\eta\)-redex. When a LAMBDA instruction is
...
\[
\lambda x.(((\lambda y.\lambda z.z)\ \underline{(x\ x)})\ \underline{\underline{x}})
\]
would be detected because the variable \(x\) is only encountered once (the
doubly underlined occurrence) during forward traversal; the occurrences in the
singly underlined subexpression are never encountered.
The expression
\[
\lambda x.(((\lambda y.\lambda z.z)\ x)\ x)
\]
is an example of an \(\eta\)-redex that is not detected, because the \(x\)
...
\section[Enhanced Compilation]{Enhanced Compilation and von-Neumann Plus Architectures}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.62\textwidth]{assets/chapter5/figure-5-6.png}
\caption[Comparing general and immediate instructions]{A comparison of code sequences for the expression \(2 \times 3 +
