...
``red2_engine.instructions``' older 32-bit compiler-image encoding.  The
faithful ``MuredMachine`` has additional opcodes and machine-visible metadata
...
in ``red2_engine.pipelinec_vectors``.
"""
...
# PypelineC legacy exploration entry: red2_step_word(pc_word, q, direction)
