...
from concrete_red2_machine import abi as hw
from concrete_red2_machine.pipelinec_vectors import RED2ABICodec


def _loaded_machine(*, memory_words: int = 32, control_words: int = 8) -> AbstractRED2Machine:
...
def _encoded_memory(codec: RED2ABICodec, machine: AbstractRED2Machine) -> list[int]:
