...
`abs` directly runs the Abstract RED2 Machine; there is no `--faithful` or compatibility-mode switch.
...
```sh
mise run abs --expr "(+ 2 3)" --quantum 20
```
