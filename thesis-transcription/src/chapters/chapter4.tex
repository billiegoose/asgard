...
LAMBDA Instruction The LAMBDA instruction is responsible for implementing Rules C1-C3 and Rule C9. If the LAMBDA is applied to an argument (i.e., is part of a \(\beta\)-redex) and there is quantum available, a closure containing the argument is placed in the environment area. Figure 4.11 illustrates this situation.
