...
\caption{All of RED2's built-in primitive operations assist in memory
...
\caption{The IF primitive demonstrates why subgraphs must be promptly
...
\caption{Forward execution of a VAR instruction that is not the head of a
...
\caption{Execution of a JOIN instruction. If the destination of the JOIN is an
...
\caption{Contraction of an \(\eta\)-redex. When a LAMBDA instruction is
...
\caption{A comparison of code sequences for the expression \(2 \times 3 +
