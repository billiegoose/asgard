...
in declarative languages describe \underline{what} values are computed, unlike
programs in conventional imperative languages (such as PASCAL or ADA) which
describe \underline{how} values are computed. This fundamental shift in viewpoint is
...
\underline{machine implementation}. Chapter 3 introduces the syntax and operational semantics
