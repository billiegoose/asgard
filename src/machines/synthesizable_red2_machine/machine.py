...
``RED2_SYNTH_SEMANTICS_COMPLETE`` becomes 1 the explicit synthesis gate must
...
@MAIN(25.0)
def SynthesizableRED2Machine(command: red2_command_t) -> red2_status_t:
    ...
    return red2_status_t(
        ...
        semantics_complete=RED2_SYNTH_SEMANTICS_COMPLETE,
    )
